...
class Migrate extends CI_Controller{
    ...
    protected function executarDdl(){
        ...
        $this->db->query("CREATE TABLE if not exists pais (
        ...
        $this->db->query("DROP TABLE IF EXISTS estado CASCADE");
        $this->db->query("DROP TABLE IF EXISTS cidade CASCADE");
        $this->db->query("CREATE TABLE IF NOT EXISTS estado (
                                id serial not null,
        ...
        $this->db->query("INSERT INTO estado (id, nome, uf, pais) VALUES
    (1, 'Acre', 'AC', 1),
    (2, 'Alagoas', 'AL', 1),
    (3, 'Amazonas', 'AM', 1),
    (4, 'Amapá', 'AP', 1),
