...
class Migrate extends CI_Controller{
    ...
    protected function executarDdl(){
        ...
        $this->db->query("ALTER TABLE usuarios ADD COLUMN  logado boolean");
        $this->db->query("ALTER TABLE usuarios ADD COLUMN  session_coo varchar(10000)");
        $this->db->query("ALTER TABLE usuarios add column  email varchar(1000)");
        $this->db->query("ALTER TABLE usuarios add column  datanasc date");
        $this->db->query("ALTER TABLE usuarios add column  telcel varchar(1000)");
