<div class="user-data full-width">
    ...
    <div class="sugguest-user">
        <div class="sugguest-user-dt">
            ...
            <a href="user_dashboard_activity.html"><h4>João</h4></a>
        </div>
    ...
    <div class="sugguest-user">
        <div class="sugguest-user-dt">
            ...
            <a href="user_dashboard_activity.html"><h4>Marcos</h4></a>
        </div>
        <button class="request-btn"><i class="fas fa-user-plus"></i></button>
    </div>
    <div class="sugguest-user">
        <div class="sugguest-user-dt">
            ...
            <a href="user_dashboard_activity.html"><h4>Maria</h4></a>
        </div>
        <button class="request-btn"><i class="fas fa-user-plus"></i></button>
    </div>
    <div class="sugguest-user">
        <div class="sugguest-user-dt">
            ...
            <a href="user_dashboard_activity.html"><h4>Cristiane</h4></a>
        </div>
        <button class="request-btn"><i class="fas fa-user-plus"></i></button>
    </div>
    <div class="sugguest-user">
        <div class="sugguest-user-dt">
            ...
            <a href="user_dashboard_activity.html"><h4>Carlos</h4></a>
        </div>
        <button class="request-btn"><i class="fas fa-user-plus"></i></button>
    </div>
</div>