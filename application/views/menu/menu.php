                        ...
                        <ul class="group-icons">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu user-request-dropdown dropdown-menu-right">
                                    ...
                                    <div class="user-request-list">
                                        <a href="<?= site_url('my_dashboard_all_requests/My_dashboard_all_requests/index') ?>" class="view-all">Visualizar todos convites</a>
                                    </div>
                                </div>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu notification-dropdown dropdown-menu-right">
                                    ...
                                    <div class="user-request-list">
                                        <a href="<?= site_url('my_dashboard_all_notifications/My_dashboard_all_notifications/index') ?>" class="view-all">Visualizar todas notificações</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
